// src/queries/overall/integrationstatus.js
...
export async function run(containers, options = {}) {
    ...
    try {
        ...
        Object.keys(statusCounts).forEach(intStatus => {
            ...
            // Total metrics
            metrics.push({
                metric: `${this.metricBase},integration_status=${normalizedStatus},country=total`,
            ...
            ['au', 'nz'].forEach(country => {
                metrics.push({
                    metric: `${this.metricBase},integration_status=${normalizedStatus},country=${country}`,
            ...
            contractStatuses.forEach(cStatus => {
                ...
                metrics.push({
                    metric: `${this.metricBase},integration_status=${normalizedStatus},contract_status=${cStatus},country=total`,
                    value: count,
                    timestamp
                });
            });

        ...
        run: async (containers, win) => {
            ...
            try {
                ...
                failedRecordsGrouped.forEach((data) => {
                    console.log(`📈 [CONTRACTFAILED-WEEK] ${data.entityType} | ${data.errorCode} | ${data.errorMessage} | Failure Type: ${data.failureType} | Unique Contracts: ${data.uniqueContracts.size}`);
                    metrics.push({

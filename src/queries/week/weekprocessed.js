...
export const queries = [
    {
        ...
        run: async (containers, win) => {
            ...
            for (const [contractId, { contractRow, entity }] of latestContractByContractId) {
                ...
                console.log(`📊 [CONTRACTPROCESSED-WEEK] Processing latest upload for contract ${contractId}: ${batchId} -> status=${status}, country=${country}, contractStatus=${cs}, attempts=${attempts}, timestamp=${contractRow.timestamp}`);
